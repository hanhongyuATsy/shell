...
PATH_BESTBUY="/mnt/d/git_code/Dbestbuy/src/"
PATH_DPRICE="/mnt/d/git_code/DPrice/"
...
function diff_dir(){
    ...
    do
        ...
        then
            ...
            DIFF_FULL_NAME=`echo ${DIFF_PATH_DPRICE_FULL_NAME:23}`
...
function read_dir(){
    ...
    do
        ...
        then
            ...
            FULL_NAME=`echo ${PATH_BESTBUY_FULL_NAME:29}`
